...
后记中的日期可以作为提示，但并不遵循统一规则。不同奖牌的日期可能表示首次出现、身份确认，或者持久收集标记实际写入的时间。
...
- Path A 提供 白羊座、天蝎座 和 处女座；
- Path B 提供 双子座 和 射手座；
- 水瓶座、金牛座 和 狮子座 可以在 Path A 或 Path B 一侧取得；
...
- 双鱼座、巨蟹座 和 摩羯座 会在 D9 写入，即使其准确星座身份要到之后才确认。
...
D23，Dave 在 Roswell 房间的床头柜上发现奖牌。游戏会立即写入 白羊座，Oswin 随后确认其身份。
...
- 双鱼座 和 摩羯座 使用 D9，即使其身份要到 D16 才确认。
