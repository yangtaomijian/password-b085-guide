...
|---|---|---|---|
| `dragonlove >= 5` | D6 Orlando 晚餐后；D9 早晨 | D6 要求 Orlando 线和 D6 金库状态成功 | D6 中，Orlando 会以帮助 Dave 为 Dean 做准备为由提出接吻练习，并显示 `orlandokiss`。低于 5 时会跳过练习吻。D9 早晨，5—9 点会进入较犹豫的安慰剧情：Orlando 会询问自己能否帮忙，但仍显得犹豫。 |
