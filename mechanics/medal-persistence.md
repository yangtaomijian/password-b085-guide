...
重复记录不代表存在多枚同名奖牌。不同剧情分支可能分别记录同一枚奖牌，后续确认场景也可能再次记录它。

双鱼座、巨蟹座和摩羯座会在对应角色线的 D9 场景中首次记录，并可能在 D16 的 Path A/B 奖牌盘点场景中再次记录。后一次只是再次确认，不是第二枚收集品，也不是额外要求。
