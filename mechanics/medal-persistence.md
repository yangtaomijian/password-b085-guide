...
相对而言，双鱼座、巨蟹座和摩羯座会在各自 D9 角色线场景中写入，即使其准确星座身份要到之后才得到确认。
...
双鱼座、巨蟹座和摩羯座会在对应角色线的 D9 场景中首次写入，并可能在 D16 的 Path A/B 奖牌盘点场景中再次写入。后一次只是再次确认，不是第二枚收集品，也不是额外要求。

处女座和射手座也会在多个互斥的关系结局分支中重复写入：
...
1. 每枚奖牌是否真正到达游戏正式记录它的剧情节点，而不只是看过首次发现场景；
