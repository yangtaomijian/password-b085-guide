...
Password b0.7 与 b0.85 之间经核验的功能、剧情互动、密码、画廊与图片资源变化。
:::

::: {.g-col-12 .g-col-md-6}
### [旧版本线路档案](versions/legacy-routes.md)

Password b0.7 与 b0.85 之间已移除的线路分支，以及与角色线和字母线有关的历史差异。
:::

::: {.g-col-12 .g-col-md-6}
### [旧版本密码档案](versions/legacy-passwords.md)

Password b0.7 中 D7 的三个可接受输入，以及已从 b0.85 正常流程移除的 D11 可选金库。
:::

::: {.g-col-12 .g-col-md-6}
### [旧版本机制档案](versions/legacy-mechanics.md)

Password b0.7 中 Path A 的持久状态、D8 Oswin 自由问答，以及后来被移除或重组的机制。
:::
...
本站的现行攻略适用于 **Password b0.85**。版本档案另行比较 b0.7 与 b0.85 中已经删除、替换或重新组织的内容，仅供历史参考，不应与 b0.85 当前机制混用。

本站为非官方玩家整理，不隶属于游戏作者 Grizz 或发行平台，也不是完整 Wiki；本站不提供游戏本体、完整游戏脚本、提取后的 CG 文件或未经授权的第三方素材。

## 本站资料来源

本站以原 B 站攻略专栏为基础，并结合 b0.85 当前内容、b0.7 与 b0.85 源码对照及相关资源核验，重新整理为可检索的攻略与机制资料库：

- [查看本站内容最初来源的 B 站攻略专栏](https://www.bilibili.com/opus/753129391801761813)

与早期专栏相比，本站更侧重可检索的剧情结构、收集条件、机制说明和版本差异，不再保留大篇幅剧情概览。
