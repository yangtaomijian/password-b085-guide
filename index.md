...
description: "《Password》b0.85 的剧情线路、密码提示、奖牌、CG、后记与机制说明"
comments: false
toc: false
---
...
查看 b0.7 中已删除的 D6 离开宅邸分支，以及角色线和字母线的历史差异。
:::

::: {.g-col-12 .g-col-md-6}
### [旧版本密码档案](versions/legacy-passwords.md)

查看 b0.7 中 D7 的三个可接受输入（其中两个不能推进主线），以及已从 b0.85 移除的 D11 可选金库。
:::
...
本站以原 B 站攻略专栏为基础，并结合 b0.85 现行内容和 b0.7—b0.85 版本差异，重新整理为可检索的攻略与机制资料库：
