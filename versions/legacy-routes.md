---
title: "旧版本线路档案"
description: "Password 早期版本的前十天分支与字母线导图存档"
toc: true
---
...
三张图均为攻略整理图，不是游戏作者发布的官方流程图。

## 前十天分支

![Password 旧版前十天分支](../assets/legacy-route-first10days.jpg){fig-alt="Password 旧版本 D1 至 D10 角色线、密码和字母线分支图"}
